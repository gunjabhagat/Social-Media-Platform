      ...
      <div className='w-[90%] lg:max-w-[60%]  h-[600px] bg-white rounded-2xl flex justify-center items-center overflow-hidden border-2 border-[#1a1f23]'>
        <div className='w-full lg:w-[50%] h-full bg-white flex flex-col items-center justify-center p-[10px] gap-[20px]'>
          ...
          <div className='flex gap-[10px] items-center text-[20px] font-semibold mt-[40px]'>
              ...
              <img src='https://res.cloudinary.com/dcknpu5xk/image/upload/v1754929080/WhatsApp_Image_2025-08-11_at_20.17.46_1d844068_1__cleanup_rebmq0.png' alt="" className='w-[70px]'/>
          </div>
        ...
        <div className='md:w-[50%] h-full hidden lg:flex justify-center items-center bg-[#000000] flex-col gap-[10px] text-white text-[16px] font-semibold rounded-l-[30px] shadow-2xl shadow-black'>
          <img src= "https://res.cloudinary.com/dcknpu5xk/image/upload/v1754926285/WhatsApp_Image_2025-08-11_at_20.17.46_1d844068_f7crb9.jpg" alt="" className='w-[90]%]'/>
       
<p className="bg-gradient-to-r from-purple-300 to-pink-300 bg-clip-text text-transparent italic text-[18px] tracking-wide">
  Share Your World, Discover Theirs
</p>
